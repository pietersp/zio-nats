...
See [Configuration](../guides/06-configuration) for auth, TLS, environment variable loading,
...
|---|---|---|
| `Nats` | Core pub/sub, request-reply, connection lifecycle | [Pub/Sub](../guides/01-pubsub) |
| `JetStream` | Persistent publish + access to consumers | [JetStream](../guides/03-jetstream) |
| `JetStreamManagement` | Create/update/delete streams and consumers | [JetStream](../guides/03-jetstream) |
| `KeyValue` | Read/write/watch a named KV bucket | [Key-Value](../guides/04-key-value) |
| `KeyValueManagement` | Create/delete KV buckets | [Key-Value](../guides/04-key-value) |
| `ObjectStore` | Put/get/watch a named object store bucket | [Object Store](../guides/05-object-store) |
| `ObjectStoreManagement` | Create/delete object store buckets | [Object Store](../guides/05-object-store) |

## Next steps

- [Quick start](../quickstart) — wire `Nats` into a working app in 5 minutes
- [Pub/Sub guide](../guides/01-pubsub) — the core messaging operations
- [Configuration guide](../guides/06-configuration) — auth, TLS, environment variables
